...
export default function Wheel({ people, onPersonSelected, isSpinning, setIsSpinning, onSpinStart, selectedPersonId, effectsEnabled }: WheelProps) {
  ...
  const spin = () => {
    ...
    if (people.length > 0 && effectsEnabled) {
                ...
                <g key={index}>
                  ...
                  {person && (
                    <text
                      ...
                      y={130 + 80 * Math.sin((startAngle + endAngle) / 2)}
                      textAnchor="middle"
                      dominantBaseline="middle"
